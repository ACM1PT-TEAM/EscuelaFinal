		        ...
		        <div class="container">
		            ...
		            <div class="nav-collapse collapse pull-right">
		                <ul class="nav">
		                    ...
		                    <li class="login">
		                        <g:link data-toggle="modal" controller="usuario"action="login"><i class="icon-lock"></i></g:link>
		                    </li>
		                </ul>        
		            </div><!--/.nav-collapse-->
		        </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                <ul class="social pull-right">
                    ...
                    <li><a href="http://mgarciaisaia.github.io/2048dbz/"><i class="icon-dribbble"></i></a></li>
